...
### Преступаем к настройке github Action

После успешного завершения предыдущих шагов, преступаем к настройке github Action. Для автоматического запуска при каждой команде push, в директории ./github/workflows, создан файл deploy.yml -  файлы конфигурации для GitHub Actions.
...
а представленном ниже скиншоте видим страницу оповещения Dependabot.

![alt text](https://github.com/alekseypopkov/dso_test/blob/main/png/2dependabot-action1.png.png)


### Зоны роста

Зоны роста для всех инструментов вижу в осуществлении настройки оповещения в телеграм канал.
