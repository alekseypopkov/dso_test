...
2.3. После успешного завершения предыдущих шагов, преступаем к настройке github Action. Для автоматического запуска при каждой команде push, в директории ./github/workflows, создан файл deploy.yml -  файлы конфигурации для GitHub Actions.
...
Уровень уязвимости: Критическая; Высокая; Умеренная; Низкая.
