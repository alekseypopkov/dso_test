...
Клонируем подготовленный репозиторий на сервер в директорию /root; копируем его в директорию /opt и запускаем сервис; в директории /root клонированный репозиторий удаляем.
